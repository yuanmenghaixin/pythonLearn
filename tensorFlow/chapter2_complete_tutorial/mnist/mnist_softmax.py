...
# Import data
import tensorFlow.chapter2_complete_tutorial.mnist.input_data
mnist = tensorFlow.chapter2_complete_tutorial.mnist.input_data.read_data_sets("/tmp/data/", one_hot=True)
